...
func Test_newGame_LFirst(t *testing.T) {
	g := newGame(func() block {
		return buildLBlock()
	})

	if g.currentBlock.block.shape != lBlock {
		t.Errorf("expected shape %c but got %c", lBlock, g.currentBlock.block.shape)
	}
	...
	assertBoardIs(t, g, [20][10]Tile{
		{None, None, None, None, None, Orange, None, None, None, None},
		{None, None, None, Orange, Orange, Orange, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
...
func Test_newGame_IFirst(t *testing.T) {
	g := newGame(func() block {
		return buildIBlock()
	})

	if g.currentBlock.block.shape != iBlock {
		t.Errorf("expected shape %c but got %c", iBlock, g.currentBlock.block.shape)
	}
	...
	assertBoardIs(t, g, [20][10]Tile{
		{None, None, None, Cyan, Cyan, Cyan, Cyan, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
...
func Test_newGame_SFirst(t *testing.T) {
	g := newGame(func() block {
		return buildSBlock()
	})

	if g.currentBlock.block.shape != sBlock {
		t.Errorf("expected shape %c but got %c", sBlock, g.currentBlock.block.shape)
	}
	...
	assertBoardIs(t, g, [20][10]Tile{
		{None, None, None, None, Green, Green, None, None, None, None},
		{None, None, None, Green, Green, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
		{None, None, None, None, None, None, None, None, None, None},
